...
import { VacinasModule } from '../src/vacinas/vacinas.module';
import { VacinasService } from '../src/vacinas/vacinas.service';
  ...
  beforeAll(async () => {
    const moduleRef = await Test.createTestingModule({
      imports: [
        ...
        SequelizeModule.forFeature([Vacinas]),
        VacinasModule,
      ],
      providers: [VacinasService]
    }).compile();

    service = moduleRef.get<VacinasService>(VacinasService);
